    ...
    <>
      ...
      <div className="content">
            ...
            <p className="ml-8">
                <ul className=" list-decimal ml-8 mb-3">
                  ...
                  <li><b>พินัยกรรมที่ควรกระทำ (มุสตะหับบะฮฺ)</b> 
                    <br></br>-- เช่น การทำพินัยกรรมให้กับเครือญาติใกล้ชิดที่ไม่มีสิทธิรับมรดก บุคคลที่มีความต้องการและขัดสน บุคคลที่มีหนี้สาธารณะประโยชน์
                  </li>
                  ...
                  <li><b>พินัยกรรมที่ไม่ควรกระทำ (มักรุฮะฮฺ)</b> 
                    <br></br>-- เช่น การทำพินัยกรรม (วะศิยะฮฺ) ให้บุคลลกระทำความชั่ว และการทำพินัยกรรม (วะศิยะฮฺ) ของผู้ยากจนที่มีทายาทรับมรดก บางครั้งการทำพินัยกรรม (วะศิยะฮฺ) เป็นสิ่งต้องห้ามหากพินัยกรรม (วะศิยะฮฺ) นั้นนำไปสู่การสร้างความเสื่อมเสียและเดือดร้อนแก่ทายาทและสังคม เช่น การทำพินัยกรรม (วะศิยะฮฺ) ในสิ่งที่ผิดหลักการอิสลาม
                  </li>
                </ul>
              </p>
          </p>
        ...
        <div>
          ...
          <p>
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;การทำพินัยกรรมของผู้เยาว์ที่มีความรู้สึกรับผิดชอบแล้วหรือมุมัยยิซ (มุมัยยิซคือ เด็กที่มีอายุประมาณ 7 ขวบที่สามารถแยกแยะได้ระหว่างสิ่งที่เป็นประโยชน์กับสิ่งที่ไม่ดี) นั้นตามทัศนะของ มัซฮับมาลิกีย์ มัซฮับหัมบะลีย์และทัศนะหนึ่งของอิหม่ามชาฟิอีย์มีความเห็นว่า พวกเขาสามารถทำพินัยกรรมได้ เพราะ พินัยกรรมมิได้ทำให้กรรมสิทธิ์ของเขาหมดไปในขณะนั้นทันที่และพินัยกรรมยังทำให้เขาได้รับผลบุญภายหลังจากที่เขาเสียชีวิตไปแล้ว (สมหวัง บินหะซัน: 2549)
            ...
            <p className="ml-8">
                <ul className=" list-decimal ml-8 mb-3">
                  <li><b>ผู้รับที่เจาะจงตัวแน่นอน </b>
                    ผู้รับที่เจาะจงตัวแน่นอน ต้องเป็นผู้ที่สามารถเข้าถือครองสิทธิ์ได้ขณะผู้ทำพินัยกรรมเสียชีวิต ต้องไม่เป็นการละเมิดหลักศาสนา ต้องระบุตัวผู้รับพินัยกรรมอย่างเจาะจงแน่นอน และผู้รับพินัยกรรมต้องมีตัวตนอยู่แล้ว รวมทั้งการทำพินัยกรรมเพื่อบูรณะมัสยิด ทั้งก่อสร้างและซ่อมแซม หรือเพื่อบำรุงมัสยิด เทียบเคียงได้กับการทำพินัยกรรมให้ผู้รับพินัยกรรมที่เจาะจง
                    แน่นอน รวมทั้งโรงเรียน บ้านพักคนเดินทางและโรงพยาบาล เข้าอยู่ในความหมายของมัสยิดเช่นกัน เพราะเป็นการทำความดี และถือว่าสิ่งเหล่านี้มีตัวตนเช่นกัน ถือว่าใช้ได้
                  </li>
                  <li><b>เงื่อนไขของผู้รับพินัยกรรมที่ไม่เจาะจงตัวแน่นอน </b>
                    การทำพินัยกรรมให้แก่ผู้รับที่ไม่ได้เจาะจงตัวแน่นอน
                    เช่น ให้แก่สถาบันหนึ่งจากบรรดาสถาบันต่างๆ หรือให้แก่คนยากจน นักวิชาการ มัสยิดและโรงเรียนเป็นต้น ที่จะมี
                    ผลใช้ได้ โดยมีเงื่อนไขว่าจะต้องไม่ทำพินัยกรรมให้แก่ฝ่ายที่กระทำความชั่วหรือทำสิ่งที่เป็นมักรูห์ ดังนั้นการทำพินัยกรรมเพื่อสร้างศาสนสถานของคนต่างศาสนา หรือเพื่อก่อสร้างสถานเริงรมณ์ที่ทำให้สิ้นเปลืองเวลา ทำให้เสียผลประโยชน์และทำให้บกพร่องในการปฏิบัติสิ่งที่เป็นวาญิบ การทำพินัยกรรมนั้นจึงใช้ไม่ได้หรือเป็นโมฆะ
                  </li>
                </ul>
            </p>
          </p>
        ...
        <div>
          ...
          <p>
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;ตามบทบัญญัติอิสลาม<a className="text-indigo underline">พินัยกรรมสามารถทำได้ด้วยการเปล่งวาจา หรือการเขียนด้วยตัวเองพร้อมมีเจตนาทำพินัยกรรม และพึงกระทำต่อหน้าบุคคลที่มีความสามารถในการเป็นพยานได้ตามกฎหมาย ไม่ว่าจะเป็นการยกทรัพย์สินให้กับบุคคลหรือองค์กรต่างๆ โดยการใช้ถ้อยคำที่ชัดเจน</a>{" "}
            <p className="mt-2">
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;หากต้องการเขียน สุนัตให้เขียนขึ้นต้นการวะศียะฮฺดั่งที่ปรากฏในรายงานของท่านอนัส อิบนุมาลิก เราะฎิยัลลอฮฺอันฮุ ว่า “แท้จริงแล้วบรรดาเศาะหาบะฮฺเขียนเริ่มต้นการวะศียะฮฺของพวกเขาว่า “นี้คือสิ่งที่ฉันสั่งเสียให้คนนั้นคนนี้ (กล่าวชื่อ) ฉันขอวะศียะฮฺว่าให้เขาปฏิญานว่าไม่มีพระเจ้าอื่นใดที่ควรแก่การอิบาดะฮฺนอกจากอัลลอฮฺองค์เดียวไม่มีภาคีสำหรับพระองค์ และแท้จริงมุฮำหมัดนั้นเป็นบ่าวและศาสนทูตของพระองค์  วันสิ้นโลกนั้นจะมาถึงแน่นอนไม่มีข้อสงสัยใดๆ และอัลลอฮฺจะทรงให้ผู้อยู่ในหลุมฝังศพนั้นฟื้นขึ้นมาใหม่  แล้วเขาก็ทำการวะศียะฮฺให้ครอบครัวของเขาที่ยังมีชีวิตอยู่หลังจากเขาจงยำเกรงอัลลอฮฺอย่างแท้จริง และทำดีต่อกันระหว่างพวกเขา เชื่อฟังอัลลอฮฺและศาสนทูตของพระองค์หากเขาเป็นมุอ์มิน แล้วก็ทำการวะศียะฮฺด้วยสิ่งนบีอิบรอฮีมและยะอฺกู๊บให้สั่งเสียลูกๆของท่าน ว่า
            <br></br>
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;ความว่า “โอ้ลูกๆ ของฉันแท้จริงอัลลอฮฺได้เลือกไว้สำหรับพวกท่านซึ่งศาสนาอิสลาม ดังนั้นท่านจงอย่าได้ตายยกเว้นในขณะที่ท่านเป็นมุสลิมเท่านั้น” [อัล-บะเกาะเราะฮฺ :132] หลังจากนั้นก็เขียนสิ่งที่เขาอยากจะวะศียะฮฺ” (หะดีษเศาะฮีหฺ บันทึกโดย  อัล-บัยฮะกีย์ หมายเลข 12463 และอัด-ดาเราะกุฏนีย์ 4/154 ดู อิรวุลเฆาะลีล หมายเลข 1647)
            </p>
            <p className="mt-2">
        ...
        <div>
          ...
          <p>
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;พินัยกรรมจะสิ้นสุด หรือหมดสภาพการมีผลบังคพบใช้ด้วยสาเหตุใดสาเหตุหนึางต่อไปนี้
            <p className="ml-6">
            <ul className=" list-decimal ml-8 mb-3">
              <li><b>การถอนหรือยกเลิกพินัยกรรมโดยผู้ทำพินัยกรรมเอง</b> การถอนหรือยกเลิกพินัยกรรมนั้นเป็นกรรมสิทธิ์ของผู้ทำพินัยกรรมที่จะกระทำเมื่อใดก็ได้การถอนนั้น อาจจะกระทำได้ด้วยวาจา -- เช่น ผู้ทำพินัยกรรมกล่าวว่า “ฉันยกเลิกพินัยกรรมที่ฉันได้ทำไว้ให้กับนาย ก.” หรือ
                “ฉันทำให้พินัยกรรมของฉันที่ทาให้นาย ก. เป็นโมฆะ” เป็นต้น หรือด้วยการกระทำที่แสดงถึง การถอนหรือยกเลิกพินัยกรรม -- เช่น ผู้ทำพินัยกรรมยกส่วนหนึ่งให้กับนาย ก. ต่อมาผู้ทำพินัยกรรมได้ขายสิ่งนั้นไป หรือทาทานหรือให้ผู้อื่นไป
              </li>
              <li>
                <b>การเสียชีวิตของผู้รับพินัยกรรมก่อนการเสียชีวิตของผู้ทำพินัยกรรม</b> เพราะพินัยกรรมเป็นการยกให้แต่ผู้รับพินัยกรรมนั้นเสียชีวิตไปก่อนการให้จึงใช้ไม่ได้ เช่นเดียวกับการให้สิ่งของกับคนตาย และเพราะพินัยกรรมจะไม่มีผลบังคับนอกจากด้วยการเสียชีวิตของผู้ทำพินัยกรรม และการสนองรับของผู้รับพินัยกรรม
              </li>
              <li>
                ...
                สิ้นสุดลง -- เช่นทรัพย์สินพินัยกรรมเป็นแกะตัวหนึ่ง แต่แกะตัวนั้นได้ตายลง พินัยกรรมก็หมดสภาพไปด้วย
              </li>
            </ul>
            <br></br>
            </p>
