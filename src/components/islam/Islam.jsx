    ...
    <section className="container islam section" id="islam">
      <div>
        ...
        <span className="section__subtitle">
          ...
          ประเทศไทยมีการยอมรับให้ผู้ที่นับถือศาสนาอิสลามสามารถใช้กฎหมายอิสลามว่าด้วยครอบครัวและมรดกบังคับแทนบทบัญญัติประมวลกฎหมายแพ่งและพาณิชย์ได้ในกรณีที่ต้องวินิจฉัยชี้ขาดคดีแพ่งในพื้นที่จังหวัดสตูล ปัตตานี ยะลา และนราธิวาส
          </span>
        </span>
