...
export const thaiData = [
  ...
  {
    id: 7,
    title: "ความสามารภของผู้ทำพินัยกรรม",
    category: "พินัยกรรม",
    subCategory: ["พินัยกรรม", "ผู้ทำพินัยกรรม"],
    description:
      "ผู้ทำพินัยกรรมต้องมีความสามารถสมบูรณ์ตามกฎหมาย ซึ่งอาจเป็นผู้เยาว์ คนไร้ความสามารถ คนวิกลจริต หรือคนเสมือนไร้ความสามารถ",
    content: <พินัยกรรม />,
    cover: img1,
  },
  {
    id: 8,
    title: "ความสามารภของผู้รับพินัยกรรม",
    category: "พินัยกรรม",
    subCategory: ["พินัยกรรม", "ผู้รับพินัยกรรม"],
    description: "ผู้รับพินัยกรรม จะพิจารณาเฉพาะในเวลาที่ผู้ทำพินัยกรรมถึงแก่ความตายเท่านั้น",
    content: <พินัยกรรม />,
    cover: img1,
  },
];
